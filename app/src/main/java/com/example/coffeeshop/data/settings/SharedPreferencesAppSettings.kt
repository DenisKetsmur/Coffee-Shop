...
import com.example.coffeeshop.data.settings.AppSettings.Companion.NO_ACCOUNT_ID
...
class SharedPreferencesAppSettings(
    ...
    override fun setCurrentEmployeeId(accountId: Long) {
        sharedPreferences.edit()
            .putLong(PREF_CURRENT_ACCOUNT_ID, accountId)
            .apply()
    }

    override fun getCurrentEmployeeId(): Long = sharedPreferences.getLong(PREF_CURRENT_ACCOUNT_ID, NO_ACCOUNT_ID)
